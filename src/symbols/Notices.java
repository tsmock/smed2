...
public class Notices {
    ...
    public static final ArrayList<Instr> Notice2 = new ArrayList<Instr>();
    public static final ArrayList<Instr> Notice3 = new ArrayList<Instr>();
    public static final ArrayList<Instr> Notice4 = new ArrayList<Instr>();
    public static final ArrayList<Instr> Notice4_1 = new ArrayList<Instr>();
    public static final ArrayList<Instr> Notice9 = new ArrayList<Instr>();
    ...
    public static final ArrayList<Instr> NoticeE = new ArrayList<Instr>();
